...
export const SPAWN_ONLY = new Map<string, HeldAtSize>([
  ...
  ["bin/commands/web.ts", { lines: 349, why: "command — serves until Ctrl-C; its parts are tested in src/web" }],
