...
[![Status](https://img.shields.io/badge/status-v0.6.0-green)](.scrum/backlog.md)
...
[![Decisions](https://img.shields.io/badge/decisions-D--001%20→%20D--084-informational)](.scrum/decisions.md)
...
> **v0.6.0.** The full MVP is met (since v0.1.0): identity, isolation, a git repository per
